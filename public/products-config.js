// NastyCanada Products Configuration
const nastyProducts = {
  hoodie: {
  ...
  snapbackHat: {
    name: "Snapback Hats",
    image: "/images/products/snapbackhat.jpg",
    placeholder: "https://placehold.co/400x450/red/white?text=Snapback+Hat",
    description: "Stylish snapback with embroidered NastyCanada logo. Perfect for everyday wear.",
    etsyLink: "https://www.etsy.com/shop/NastyCanada?section_id=hats"
  },
  dadHat: {
    name: "Dad Hats",
    image: "/images/products/dadhat.jpg",
    placeholder: "https://placehold.co/400x450/red/white?text=Dad+Hat",
    description: "Comfortable dad hat with subtle NastyCanada branding. Casual Canadian pride.",
    etsyLink: "https://www.etsy.com/shop/NastyCanada?section_id=hats"
  },
  phoneCase: {
    name: "iPhone Cases",
